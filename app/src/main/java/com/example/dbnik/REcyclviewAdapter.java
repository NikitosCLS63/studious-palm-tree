...
public class REcyclviewAdapter extends RecyclerView.Adapter<REcyclviewAdapter.ViewHolder> {
    ...
    public REcyclviewAdapter(Context context, ArrayList<Book> bookArrayList){
        this.context = context;
        this.bookArrayList=bookArrayList;
    }
    @NonNull
    @Override
    public REcyclviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.bookcard,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull REcyclviewAdapter.ViewHolder holder, int position) {
